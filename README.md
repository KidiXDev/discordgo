# About this fork
This fork is my personal modified version of discordgo that has included libdave pre-build library for Windows and Linux and support for E2EE/DAVE for my personal projects.
